...
class LevelController extends Controller
{
    ...
    // Ambil data level dalam betuk json untuk datatables
    ...
    public function destroy(String $id)
    {
        ...
        try {
            ...
            return redirect('/level')->with('error', 'Data level gagal dihapus karena masih terdapat tabel lain yang terkait dengan ini');
        }
    }
}
