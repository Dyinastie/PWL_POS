...
class StokController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = UserModel::all();   // ambil data barang untuk filter

        return view('stok.index', ['breadcrumb' => $breadcrumb, 'page' => $page, 'user' => $user, 'activeMenu' => $activeMenu]);
    }

    // Ambil data stok dalam betuk json untuk datatables
    ...
    public function destroy(String $id)
    {
        ...
        try {
            ...
            return redirect('/stok')->with('error', 'Data stok gagal dihapus karena masih terdapat tabel lain yang terkait dengan ini');
        }
    }
}
